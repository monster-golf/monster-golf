...
function SendForm(formdata, q, updone, uperr) {
    if (formdata != "") {
        if (!asyncSend) {
            if (document.forms[0].tourneyId) {
                formdata += "&tourney=" + document.forms[0].tourneyId.value;
            }
            if (document.forms[0].roundNum) {
